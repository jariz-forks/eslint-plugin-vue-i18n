...
exports.LocaleMessages = exports.FileLocaleMessage = exports.UseI18nLocaleMessage = exports.BlockLocaleMessage = exports.LocaleMessage = void 0;
...
class UseI18nLocaleMessage extends LocaleMessage {
...
exports.UseI18nLocaleMessage = UseI18nLocaleMessage;
class FileLocaleMessage extends LocaleMessage {
    constructor({ fullpath, locales, localeKey, localePattern, exportName }) {
        ...
        this._exportName = exportName !== null && exportName !== void 0 ? exportName : null;
    ...
    getMessagesInternal() {
        ...
        if (this._exportName) {
            return ((_a = raw[this._exportName]) !== null && _a !== void 0 ? _a : {});
        }
        return raw;
    }
}
